...
public class ShipView {
	...
	trianglePolygon.getPoints().setAll((double)x,(double)y ,(double)x,(double)y+(double)heigth,(double)x-(double)width/5,(double)y);
	trianglePolygon.setFill(color);
	
	Polygon trianglePolygon1=new Polygon();
	trianglePolygon1.getPoints().setAll((double)x+width,(double)y ,(double)x+width,(double)y+(double)heigth,(double)x+width+(double)width/7,(double)y);
